...
const Footer = () => {
    return (
        <div>
            <footer className="dark:bg-teal-500 text-white">
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            <h2 className="mb-6 text-xl font-bold uppercase dark:text-white">Company</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-xl font-bold uppercase dark:text-white">Help center</h2>
                            <ul className="font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-xl font-bold uppercase dark:text-white">Legal</h2>
                            <ul className="font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-xl font-bold uppercase dark:text-white">Download</h2>
                            <ul className="font-medium">
                                <li className="mb-4">
                    ...
                    <div className="px-4 py-6 bg-teal-600 md:flex md:items-center md:justify-between">
                        <span className="text-smsm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
                        </span>
